...
| cairo.o3.partition.split.min.size              | 50MB              | The estimated partition size on disk. This setting is one of the conditions to trigger [auto-partitioning](/docs/operations/capacity-planning/#auto-partitioning)    |
